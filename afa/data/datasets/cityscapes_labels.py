...
Label = namedtuple(
    ...
    [
        ...
        # evaluation server.
        "trainId",  # Feel free to modify these IDs as suitable for your
        # method. Then create ground truth images with train IDs, using the
        # tools provided in the 'preparation' folder. However, make sure to
        # validate or submit results to our evaluation server using the regular
        # IDs above!
        # For trainIds, multiple labels might have the same ID. Then, these
        # labels are mapped to the same class in the ground truth images. For
        # the inverse mapping, we use the label that is defined first in the
        # list below.
        # For example, mapping all void-type classes to the same ID in
        # training, might make sense for some approaches.
        # Max value is 255!
